...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_1c943c59f0754b9df74ad833cfff53f6d4642c19": function($0, $1, $2, $3) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);Module.STDWEB.from_js($0, (function(){console.log ("Key: " + ($1)+ ", location: " + ($2)+ ", pressed: " + ($3));})());
            },
            ...
            "__extjs_57ca0d84d50ee928abb24bc2a91d05859357a497": function($0) {
                Module.STDWEB.from_js($0, (function(){return Math.floor ((Math.random ()* 40000))/ 100 ;})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'wasm_demo_rs'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'wasm_demo_rs':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" ) {
        ...
        const wasm_path = path.join( __dirname, "wasm-demo-rs.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "wasm-demo-rs.wasm" )
